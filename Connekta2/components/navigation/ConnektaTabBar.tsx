...
/** RN tab bar — Expo UI Button cannot host Ionicons (crashes SwiftUIVirtualView in Expo Go). */
          ...
          return (
            <Pressable
              ...
              {focused ? (
                ...
                <Ionicons name={meta.icon} size={26} color={colors.textMuted} style={{ opacity: 0.75 }} />
              )}
            </Pressable>
          );
        })}
